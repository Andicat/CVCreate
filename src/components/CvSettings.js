                ...
                <main className={'main ' + this.props.transitionClass}>
                    <div className='cv-view'>
                        <div className='cv cv--settings'>
                            ...
                            <p>Выделить несколько блоков можно движением мышки с зажатой левой клавишей. А также с зажатой клавишей Ctrl и кликом мышки по нужным блокам. Первый выделенный блок будет выделен<span style={{color: '#a14141'}}>отдельным цветом</span> от остальных. Варианты действий с несколькими блоками:</p>
                            <ul>
                                <li>
